...
# Tom's Auto Rice Boostrapping Script (TARBS)
# by Tom Tarpey <tomtarpey@hotmail.com>
# License: MIT
...
# DEFAULTS:
[ -z ${dotfilesrepo+x} ] && dotfilesrepo="https://github.com/tomtarpey/dotrice.git"
[ -z ${progsfile+x} ] && progsfile="https://raw.githubusercontent.com/tomtarpey/TARBS/master/progs.csv"
...
finalize(){ \
	...
	echo "exec_always --no-startup-id notify-send -i ~/.scripts/pix/larbs.png '<b>Hello Tom:</b> Do you want to play a game?' -t 10000"  >> "/home/$name/.config/i3/config"
...
putgitrepo "https://github.com/tomtarpey/mozi.git" "/home/$name/.mozilla/firefox"
